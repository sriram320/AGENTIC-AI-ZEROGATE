...
class GroqProvider(OpenAIProvider):
    def __init__(
        ...
        **kwargs: str | int | None,
        ...
        super().__init__(api_key=api_key, endpoint=endpoint or default_endpoint, **kwargs)
        self.api_key = api_key or os.environ.get("GROQ_API_KEY")

    @property
    def provider_name(self) -> cs.Provider:
        return cs.Provider.GROQ
...
PROVIDER_REGISTRY: dict[str, type[ModelProvider]] = {
    ...
    cs.Provider.GROQ: GroqProvider,
    cs.Provider.TOGETHER: TogetherProvider,
}
