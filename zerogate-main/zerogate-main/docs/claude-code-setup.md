# Claude Code Setup for ZeroGate MCP Server

Connect ZeroGate to Claude Code for powerful codebase analysis and editing.
...
**Replace**:
- `/absolute/path/to/zerogate` - Where you cloned this repo
