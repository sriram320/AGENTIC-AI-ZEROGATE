---
description: "Install ZeroGate and set up Memgraph for multi-language codebase analysis."
---
...
```bash
pip install 'zerogate[treesitter-full]'
```
...
```bash
pip install 'zerogate[treesitter-full,semantic]'
```
