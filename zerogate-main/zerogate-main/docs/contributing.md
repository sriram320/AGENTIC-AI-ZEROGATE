---
description: "Contribution guidelines for ZeroGate including setup, code standards, and PR process."
---

# Contributing

Thank you for your interest in contributing to ZeroGate!

## Getting Started

1. **Browse Issues**: Check out the [GitHub Issues](https://github.com/krrishitejas/zerogate/issues) to find tasks that need work. Look for `good first issue` and `help wanted` labels.
...
```bash
git clone https://github.com/YOUR-USERNAME/zerogate.git
cd zerogate
make dev
```
