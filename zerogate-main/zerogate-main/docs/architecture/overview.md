---
description: "Architecture overview of ZeroGate's two-component system for codebase analysis."
---

# Architecture Overview

ZeroGate consists of two main components that work together to analyze and query codebases.
